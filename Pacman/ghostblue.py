...
ANIMATION_RIGHT = [('%s/ghost_b.png' % ICON_DIR),
            #('%s/pacman_r.png' % ICON_DIR),
           # ('%s/pacman_r.png' % ICON_DIR),
           # ('%s/pacman_r.png' % ICON_DIR),
            ('%s/pacman.png' % ICON_DIR)]
ANIMATION_LEFT = [('%s/ghost_b.png' % ICON_DIR),
            # ('%s/pacman_l.png' % ICON_DIR),
            # ('%s/pacman_l.png' % ICON_DIR),
            # ('%s/pacman_l.png' % ICON_DIR),
            ('%s/ghost_b.png' % ICON_DIR)]
ANIMATION_UP = [('%s/ghost_b.png' % ICON_DIR),
            # ('%s/pacman_u.png' % ICON_DIR),
            # ('%s/pacman_u.png' % ICON_DIR),
            # ('%s/pacman_u.png' % ICON_DIR),
            ('%s/pacman.png' % ICON_DIR)]
ANIMATION_DOWN = [('%s/ghost_b.png' % ICON_DIR),
...
ANIMATION_STAY = [('%s/ghost_b.png' % ICON_DIR, 0.1)]


class Ghost1(sprite.Sprite):
