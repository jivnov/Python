...
ANIMATION_RIGHT = [('%s/ghost_p.png' % ICON_DIR),
                   # ('%s/pacman_r.png' % ICON_DIR),
                   # ('%s/pacman_r.png' % ICON_DIR),
                   # ('%s/pacman_r.png' % ICON_DIR),
                   ('%s/ghost_p.png' % ICON_DIR)]
ANIMATION_LEFT = [('%s/ghost_p.png' % ICON_DIR),
                  # ('%s/pacman_l.png' % ICON_DIR),
                  # ('%s/pacman_l.png' % ICON_DIR),
                  # ('%s/pacman_l.png' % ICON_DIR),
                  ('%s/ghost_p.png' % ICON_DIR)]
ANIMATION_UP = [('%s/ghost_p.png' % ICON_DIR),
                # ('%s/pacman_u.png' % ICON_DIR),
                # ('%s/pacman_u.png' % ICON_DIR),
                # ('%s/pacman_u.png' % ICON_DIR),
                ('%s/ghost_p.png' % ICON_DIR)]
ANIMATION_DOWN = [('%s/ghost_p.png' % ICON_DIR),
...
ANIMATION_STAY = [('%s/ghost_p.png' % ICON_DIR, 0.1)]


class Ghost4(sprite.Sprite):
    def __init__(self, x, y):
        sprite.Sprite.__init__(self)
        self.xvel = 20  # скорость перемещения. 0 - стоять на месте
